...
public class UserController {
    ...
    @RequestMapping(AdminUrls.UserControlList)
    public String getUserControlListPage(Model model) {
        ...
        model.addAttribute("positionList",positionService.getAll());
        model.addAttribute("roleList",userRoleService.getRoleList());
        return AdminTemplates.UserControlList;
    }


    @RequestMapping(value = AdminUrls.UserControlListAjax, produces = "application/json")
    @ResponseBody
    ...
    @RequestMapping(value = AdminUrls.UserControlStatus,method = RequestMethod.POST)
    @ResponseBody
