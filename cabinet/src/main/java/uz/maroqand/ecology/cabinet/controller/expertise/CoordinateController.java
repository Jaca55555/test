...
public class CoordinateController {
    ...
    public HashMap<String,Object> coordinateListAjax(
        ...
        Page<Coordinate> coordinatePage = coordinateService.findFiltered(userService.isAdmin()?null:user.getOrganizationId(),id, tin, name, number ,regionId, subRegionId, dateBegin, dateEnd, pageable);
