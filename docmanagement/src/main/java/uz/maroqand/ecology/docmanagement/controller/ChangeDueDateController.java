...
public class ChangeDueDateController {
    ...
    @RequestMapping(value = DocUrls.ChangeDueDateList, method = RequestMethod.POST, produces = "application/json")
    @ResponseBody
    public HashMap<String, Object> getChangeDueDateList(
...
//                receiverId=null;
    ...
    @RequestMapping(ChangeDueDateView)
    public String getIncomingViewPage(
        ...
        model.addAttribute("action_url",ChangeDueDateTask);
        model.addAttribute("action_uri",ChangeDueDateDeny);
        return DocTemplates.ChangeDueDateView;
    }
