...
public interface ConclusionRepository extends JpaRepository<Conclusion, Integer>, JpaSpecificationExecutor<Conclusion> {
    ...
    List<Conclusion> findAllByDeletedFalse();
    ...
    Conclusion findByNumberAndDeletedFalse(String regNumber);

    Conclusion findTop1ByNumberAndDeletedFalseOrderByIdDesc(String regNumber);
}