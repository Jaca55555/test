...
public interface NotificationRepository extends JpaRepository<Notification, Integer>, JpaSpecificationExecutor<Notification> {
    ...
    Notification findTop1ByApplicationNumberAndStatusAndTypeAndDeletedFalseOrderByIdDesc(Integer applicationNumber, NotificationStatus status, NotificationType type);
}
